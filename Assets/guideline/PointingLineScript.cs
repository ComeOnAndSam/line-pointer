...
public class PointingLineScript : MonoBehaviour
{
    ...
    public Transform gazeObjTransform;
    ...
    void Update()
    {
        bool bGazeObjectHasFocus = hasFocus;
        ...
        if (bGazeObjectHasFocus)
        {
            ...
            if (m_NumLinePositions > 2)
            {
                ...
                Transform rGazeObjectTransform = gazeObjTransform;
